	 					...
	 					<div class="row">
	 						<div class="col-md-3 bg-success mx-2 " style="height: :130px;">
	 							...
	 							<div class="row">
	 								...
	 								<div class="col-md-4">
	 									<a href="admin.php"><i class="fa fa-user-tie fa-3x my-4 " style="color: white;"></i> </a> 
				...
				<div class="col-md-3 bg-success mx-2 my-2" style="height: :130px;">
					<div class="col-md-12">
	 							<div class="row">
	 								...
	 								<div class="col-md-4">
	 									<a href="income.php"><i class="fa fa-money-check-dollar fa-3x my-4 " style="color: white;"></i> </a> 
